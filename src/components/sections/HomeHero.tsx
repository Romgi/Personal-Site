...
export function HomeHero({ name, title, tagline, image }: HomeHeroProps) {
  return (
    <section
      data-home-hero
      className="relative h-[320svh] overflow-visible"
    ...
    >
      <div className="sticky top-0 h-svh overflow-hidden">
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="hero-ambient absolute inset-0 z-[1] bg-[radial-gradient(circle_at_76%_26%,rgba(37,99,235,0.34),transparent_34%),radial-gradient(circle_at_52%_74%,rgba(77,124,255,0.14),transparent_32%)]"
          />
          <div
            aria-hidden="true"
            className="absolute inset-0 z-[2] bg-[linear-gradient(90deg,rgba(2,6,23,0.99)_0%,rgba(2,6,23,0.9)_46%,rgba(2,6,23,0.76)_100%)]"
          />
          <div
            aria-hidden="true"
            className="absolute inset-0 z-[3] bg-[linear-gradient(180deg,rgba(2,6,23,0.16)_0%,transparent_34%,rgba(2,6,23,0.74)_100%)]"
          />
          <div
            aria-hidden="true"
            className="hero-grid absolute inset-0 z-[4] opacity-[0.14] [background-image:linear-gradient(rgba(96,141,255,0.26)_1px,transparent_1px),linear-gradient(90deg,rgba(96,141,255,0.16)_1px,transparent_1px)] [background-size:64px_64px]"
          />
          <div
            aria-hidden="true"
            className="hero-scan absolute inset-y-0 left-[-24%] z-[5] w-1/2 bg-[linear-gradient(90deg,transparent,rgba(96,141,255,0.09),transparent)]"
          />
          <div
            data-home-hero-veil
            aria-hidden="true"
            className="absolute inset-0 z-[6] opacity-0 bg-[radial-gradient(90%_78%_at_50%_44%,rgba(28,33,42,0.88)_0%,rgba(26,29,35,0.98)_72%,rgba(26,29,35,1)_100%)]"
          />
          <div
            data-home-hero-aperture
            aria-hidden="true"
            className="absolute left-1/2 top-1/2 z-[7] size-36 -translate-x-1/2 -translate-y-1/2 rounded-full border border-blue-200/35 opacity-0 shadow-[0_0_80px_rgba(77,124,255,0.28)]"
          />
